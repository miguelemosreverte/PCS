...
class ExencionProjectionistMicroservice(implicit context: CassandraProjectionistMicroserviceRequirements)
  ...
  override def route: Route = {
    ...
    val projectionist = ExencionProjectionHandler(monitoring, system)
    projectionist.run()
    projectionist.route
  }
}
