...
case class SujetoTributarioTransaction()(implicit actorRef: ActorRef, ec: ExecutionContext, monitoring: Monitoring)
    extends ActorTransaction[SujetoTri](monitoring) {

  val topic = "DGR-COP-SUJETO-TRI"

  override def processCommand(registro: SujetoTri): Future[Done] = {
