...
import spec.consumers.registrales.parametrica_recargo.ParametricaRecargoProyectionistAcceptance.ParametricaRecargoProjectionTestkit

@Ignore
class ParametricaRecargoProyectionistAcceptance extends ParametricaRecargoProyectionistSpec {
  private val cassandraTestkit: CassandraTestkitProduction = CassandraTestkitProduction.apply()
  override val ProjectionTestkit = new ParametricaRecargoProjectionTestkit(cassandraTestkit)
...
object ParametricaRecargoProyectionistAcceptance {
  class ParametricaRecargoProjectionTestkit(c: CassandraTestkitProduction)(implicit system: ActorSystem)
