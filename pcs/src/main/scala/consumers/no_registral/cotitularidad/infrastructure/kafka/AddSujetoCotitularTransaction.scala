...
case class AddSujetoCotitularTransaction(actorRef: ActorRef, monitoring: Monitoring)(
    implicit
    actorTransactionRequirements: ActorTransactionRequirements
) extends ActorTransaction[CotitularidadAddSujetoCotitular](monitoring) {

  def topic = "AddSujetoCotitularTransaction"
  ...
  def processMessage(cmd: CotitularidadAddSujetoCotitular): Future[Response.SuccessProcessing] = {
