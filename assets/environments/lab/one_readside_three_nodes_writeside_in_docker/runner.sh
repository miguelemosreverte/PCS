...
tmux send-keys -t 1 "\
    ...
    docker-compose -f assets/environments/lab/one_readside_three_nodes_writeside_in_docker/docker-compose.yml up -d seed  node1 node2; \
" Enter
tmux send-keys -t 2 "\
...
tmux send-keys -t 1 "\
    ...
    docker-compose -f assets/environments/lab/one_readside_three_nodes_writeside_in_docker/docker-compose.yml up -d readside1 \
" Enter
